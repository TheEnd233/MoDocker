...
# 安装PHP和Apache
RUN apt-get install apache2-bin=2.4.23-1+deb.sury.org~xenial+2 apache2-data=2.4.23-1+deb.sury.org~xenial+2 apache2=2.4.23-1+deb.sury.org~xenial+2 php libapache2-mod-php php-mcrypt php-cli php-curl php-gd php-mbstring -y
